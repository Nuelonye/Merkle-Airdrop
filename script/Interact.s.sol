...
contract ClaimAirdrop is Script {
    ...
    bytes32[] proofs = [PROOF_ONE, PROOF_TWO];
    bytes private SIGNATURE =
        hex"42b3ca31f59c840f674257490aaca82a43758ab9a3f2886182b90011cb0d26de7ef85c96d7c4c5f72859996dc7298c53511302fcaaf97ea8981b5146aece760e1c";
    ...
    function claimAirdrop(address airdrop) public {
        ...
        MerkleAirdrop(airdrop).claim(CLAIMING_ADDRESS, CLAIMING_AMOUNT, proofs, v, r, s);
        vm.stopBroadcast();
    }
